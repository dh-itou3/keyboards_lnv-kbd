...
[_MA] = LAYOUT_all(
    ...
    TT(_FN),    KC_RCTL,    KC_LWIN,    KC_LALT,    JP_MHEN,    KC_SPC, JP_HENK,    JP_KANA,    KC_RALT,    KC_PSCR,    KC_RCTL,    KC_PGUP,    KC_UP,   KC_PGDN,
                                                                                                                                    KC_LEFT,    KC_DOWN,    KC_RIGHT),
[_FN] = LAYOUT_all(
    _______,    KC_MUTE,  KC_VOLD,  KC_VOLU,    RCS(KC_M),  KC_BRID,    KC_BRIU,    LWIN(KC_P), XXXXXXX,    LWIN(KC_I), LWIN(KC_S), LWIN(KC_TAB),   LWIN(KC_E), _______,    _______,    _______,    _______,
